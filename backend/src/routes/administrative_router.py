...
from validator.auth import AdministrativeSchema, Administrative2Schema, ChangePasswordSchema, EmailRecoverySchema, RecoveryPasswordSchema
...
@token_required
@required_params(Administrative2Schema())
def register(_):
